...
class ApiModelSessionIndexTest extends PHPUnit_Framework_TestCase
{
	...
	public function testAccess()
	{
		...
		$this->assertInstanceOf('OL\\Model\\Session\\Access', $class);
	}
	
	public function testLogin()
	{
		$class = eve()->model('session')->login();
		$this->assertInstanceOf('OL\\Model\\Session\\Login', $class);
	}
	
	public function testLogout()
	{
		$class = eve()->model('session')->logout();
		$this->assertInstanceOf('OL\\Model\\Session\\Logout', $class);
	}
	
	public function testRequest()
	{
		$class = eve()->model('session')->request();
		$this->assertInstanceOf('OL\\Model\\Session\\Request', $class);
	}
